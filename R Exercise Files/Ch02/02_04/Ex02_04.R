...
sn.csv <- read.csv("C:\Users\1447308\Desktop\PERSONAL\Lynda\R Exercise Files\Ch02\02_04\social_network.csv", header = T)
...
library(foreign)
sn.spss.f <- read.spss("C:/Users/1447308/Desktop/PERSONAL/Lynda/R Exercise Files/Ch02/02_04/social_network.sav", to.data.frame=T, use.value.labels=T)
str(sn.spss.f)